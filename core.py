...
def auto_correct(word: str, dictionary: list[str] | tuple[str], alter_value: Any = None) -> Any:
    """
...
def countFreq(var: str, letters: Any) -> dict[str, int]:
    ...
    if not isinstance(letters, (str, list, tuple)):
        raise TypeError("letters must be a string, list, or tuple")
...
def Sprint(data: Any, delay: float = 0.5, end: str = "\n") -> None:
